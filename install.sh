...
echo "                    CLI: git, git-lfs, gh, mas, bun, lastpass-cli"
echo "                    Apps: Claude, iTerm2, Firefox, Chrome,"
echo "                          Rectangle, Shottr, AltTab, VS Code"
...
echo "          8. ai-sync (syncs ~/.claude config across machines)"
echo "         8b. ai-sync nightly LaunchAgent (pull + push at 2 AM)"
echo "          9. Claude Code Discord Channel"
echo "                    Bot token + access config from LastPass"
echo "         10. macOS Preferences"
